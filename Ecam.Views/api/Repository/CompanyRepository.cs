...
namespace Ecam.Framework.Repository
{
    ...
    public class CompanyRepository : ICompanyRepository
    {
        ...
        public PaginatedListResult<TRA_COMPANY> Get(TRA_COMPANY_SEARCH criteria, Paging paging)
        {
            ...
            selectFields = "ct.*" +
                           ",(((ifnull(ct.close_price, 0) - ifnull(ct.prev_price, 0)) / ifnull(ct.prev_price, 0)) * 100) as prev_percentage" +
                           ",(((ifnull(ct.close_price, 0) - ifnull(ct.week_52_high, 0)) / ifnull(ct.week_52_high, 0)) * 100) as week_52_percentage" +
                           ",(((ifnull(ct.close_price, 0) - ifnull(ct.months_3_high, 0)) / ifnull(ct.months_3_high, 0)) * 100) as months_3_percentage" +
                           ",(((ifnull(ct.close_price, 0) - ifnull(ct.months_1_high, 0)) / ifnull(ct.months_1_high, 0)) * 100) as months_1_percentage" +
                           ",(((ifnull(ct.close_price, 0) - ifnull(ct.day_5_high, 0)) / ifnull(ct.day_5_high, 0)) * 100) as day_5_percentage" +
                           ",ct.company_id as id"
                           ;
