    ...
    var methods={
        init: function(options) {
            ...
            return this.each(function() {
                ...
                var divUpDown=
                                "<div class='ms2side__updown' style='display:none'>"+
                                    "<button class='MoveTop btn btn-default' title='Move on top selected option'>"+o.labelTop+"</button>"+
                                    "<button class='MoveUp btn btn-default' title='Move up selected option'>"+o.labelUp+"</button>"+
                                    "<button class='MoveDown btn btn-default' title='Move down selected option'>"+o.labelDown+"</button>"+
                                    "<button class='MoveBottom btn btn-default' title='Move on bottom selected option'>"+o.labelBottom+"</button>"+
                                "</div>";
                ...
                if(o.search!=false&&o.optGroupSearch!=false) {
                    //var ss =
                    //	o.optGroupSearch + "<select class='small' ><option value=__null__>--All--</option></select> " +
                    //  o.search + "<input class='small' type='text' /><a href='#'> </a>";
                    var ss=
                      "<select class='small form-control' style='display:none;' ><option value=__null__>--All--</option></select> "+
                      "<input class='small form-control' type='text' placeholder='Search' /><a href='#'> </a>";
                ...
                var htmlToAdd=
                            "<div class='ms2side__div'>"+
                                ...
                                "<div class='ms2side__select available'>"+
                                ...
                                "<div class='ms2side__options'>"+
                                    ...
                                    ?
                                    ("<button class='AddOne btn btn-default' title='Add Selected'>&rsaquo;</button>"+
                                    "<button class='AddAll btn btn-default' title='Add All'>&raquo;</button>"+
                                    "<button class='RemoveOne btn btn-default' title='Remove Selected'>&lsaquo;</button>"+
                                    "<button class='RemoveAll btn btn-default' title='Remove All'>&laquo;</button>")
                                    :
                                    ("<button class='AddOne btn btn-default' title='Add Selected'>&lsaquo;</button>"+
                                    "<button class='AddAll btn btn-default' title='Add All'>&laquo;</button>"+
                                    "<button class='RemoveOne btn btn-default' title='Remove Selected'>&rsaquo;</button>"+
                                    "<button class='RemoveAll btn btn-default' title='Remove All'>&raquo;</button>")
                                    )+
                                "</div>"+
                                "<div class='ms2side__select selected'>"+
                                    ((o.labeldx||rightSearch!=false)?("<div class='ms2side__header'><span class='header-label'>"+(rightSearch!=false?rightSearch:o.labeldx)+"</span></div>"):"")+
                ...
                if(o.optGroupSearch!=false) {
                    ...
                    searchSelect.change(function() {
                        ...
                        if(sEl.val()!=lastOptGroupSearch) {
                            ...
                            setTimeout(function() {
                                if(sEl.val()=="__null__") {
                                    els=el.find("option[livevisitor !='true']:not(:selected)");
                                }
                                else {
                                    els=el.find("optgroup[label='"+sEl.val()+"']").children("option[livevisitor !='true']:not(:selected)");
                                }
                ...
                var fto=function() {
                    ...
                    var toSearch=el.find("option[livevisitor !='true']:not(:selected)");
                ...
                $(this).find("option[livevisitor !='true']").clone().appendTo(leftSel);
