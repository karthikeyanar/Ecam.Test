...
(function($,window,document,undefined) {
    ...
    $.ajax_scroll=function(element,options) {
        ...
        */
        ...
        //bind on scroll
        $(element).off('scroll').unbind('scroll').on('scroll',scrollProcess);
    };
