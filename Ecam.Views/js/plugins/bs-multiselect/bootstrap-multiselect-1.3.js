    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                ...
                else if (options.length == $('option', $(select)).length && options.disableAllSelectedText == false) {
                    return this.allSelectedText + ' <b class="caret"></b>';
                }
                else if (options.length > this.numberDisplayed && options.disableNumberDisplayed == false) {
            ...
            disableAllSelectedText: false,
            allSelectedText: 'All selected',
            disableNumberDisplayed: false,
            numberDisplayed: 3,
        ...
        buildDropdown: function() {
            ...
            if(this.options.multiple == false) {
               this.$ul.addClass("single-select");
            }
